...
public class CSV { 
	...
	public static String leerCsv() throws IOException {
		System.out.println("Esta aqui leyendo");
		String msg = "";
		...
		while((fila = csvReader.readNext()) != null) {
			...
			msg += bit.getFecha() + " " + bit.getHora() + " " + bit.getAccion() + " " + bit.getTexto() + "\n";
			bitacoras.clear();
			bitacoras.add(bit);
		}
		csvReader.close();
	...
	public static String leerAcciones(String pTipo) throws IOException {
		CSVReader csvReader = new CSVReader(new FileReader(archivo));
		String[] fila = null;
		String texto = "";
	...
	public static String leerFecha() throws IOException {
		CSVReader csvReader = new CSVReader(new FileReader(archivo));
		String[] fila = null;
		String texto = "";
